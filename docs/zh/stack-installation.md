...
3. 若想用域名访问 Kafka，请先到 **域名控制台** 完成一个域名解析
...
2. 输入账号密码（[不知道账号密码？](/zh/stack-accounts.md#rabbitmq)），成功登录到 Kafka 后台  
...
> 需要了解更多 Kafka 的使用，请参考官方文档：[Kafka Documentation](https://www.rabbitmq.com/documentation.html)

## 常见问题

#### 浏览器打开IP地址，无法访问 Kafka（白屏没有结果）？
